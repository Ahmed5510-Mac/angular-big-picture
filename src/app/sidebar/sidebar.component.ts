  ...
  normalicon(){
    ...
    this.searchiconChang=true
        ...
        leatsMessageRead:false,
            messages:[
              {id:1 ,body: 'Hello Ahmed 💝' ,time:'12:58 AM', my:true},
              {id:2 ,body: 'hi how are you?' ,time:'12:59 BM', my:false},
              {id:3 ,body: 'i am fine thanks' ,time:'1:00 AM', my:true},
              {id:3 ,body: 'send to my files' ,time:'1:01 BM', my:false},
              {id:1 ,body: 'Hello Ahmed 💝' ,time:'12:58 AM',  my:true},
              {id:2 ,body: 'hi how are you?' ,time:'12:59 BM', my:false},
              {id:3 ,body: 'i am fine thanks' ,time:'1:00 AM', my:true},
              {id:3 ,body: 'send to my files' ,time:'1:01 BM', my:false},
        ...
        messages:[
          {id:1 ,body: 'ايه الاخبار' ,time:'12:58 AM', my:true},
          {id:2 ,body: 'الحمد لله ووانت' ,time:'12:59 BM', my:false},
          {id:3 ,body: 'بخير الحمد لله شفت نور' ,time:'1:00 AM', my:true},
          {id:3 ,body: 'اليوم بازن الله' ,time:'1:01 BM', my:false}
        ]},
        { Name:'youssef Abohaty',time:'3:12 AM',leatsMessage:"ابعب الcv ",imageUrl:'../../assets/images/youssef.jpg',leatsMessageRead:false,
        messages:[
          {id:1 ,body: ' احمد عامل ايه' ,time:'12:58 BM', my:true},
          {id:2 ,body: 'الحمد لله وانت' ,time:'12:59 AM', my:false},
          {id:3 ,body: 'بخير الحمد لله  ابعت ال سيفى' ,time:'1:00 AM', my:true},
          {id:3 ,body: ' عيونى حاضر' ,time:'1:01 AM', my:false}
        ]},
        { Name:'Essam Darwish',time:'7:8 BM',leatsMessage:"ايه الاخبار يانجم",imageUrl:'../../assets/images/essam.jpg',leatsMessageRead:true,
        messages:[
          {id:1 ,body: '   السلام عليكم ' ,time:'12:58 AM', my:true},
          {id:2 ,body: '  وعليكم السلام' ,time:'12:59 B AMM', my:false},
          {id:3 ,body: '     عامل ايه ' ,time:'1:00 AM', my:true},
        ...
        messages:[
          {id:1 ,body: '   السلام عليكم ' ,time:'12:58 AM', my:true},
          {id:2 ,body: '  وعليكم السلام' ,time:'12:59 BM', my:false},
          {id:3 ,body: '     عامل ايه ' ,time:'1:00 AM', my:true},
          {id:3 ,body: '  بخير' ,time:'1:01', my:false}
        ]},
